...
const DEFAULT_CHAINS: NewChain[] = [
  ...
  },
  {
    ...
    usePrivateMempoolRpc: getUsePrivateMempoolRpc({ rpcConfig, jsonKey: "op-mainnet" }),
    defaultPrivateRpcUrl: getPrivateRpcUrl({ rpcConfig, jsonKey: "op-mainnet" }),
  },
  {
  ...
  },
  {
    ...
    usePrivateMempoolRpc: getUsePrivateMempoolRpc({ rpcConfig, jsonKey: "op-sepolia" }),
    defaultPrivateRpcUrl: getPrivateRpcUrl({ rpcConfig, jsonKey: "op-sepolia" }),
  },
  {
...
> = {
  ...
  // OP Mainnet - Etherscan V2 (Optimistic Etherscan)
  10: {
    chainType: "evm",
  ...
  // OP Sepolia - Etherscan V2 (Optimistic Etherscan)
  11155420: {
    chainType: "evm",
